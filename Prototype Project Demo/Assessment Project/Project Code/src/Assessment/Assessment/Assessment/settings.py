...
SECRET_KEY = 'django-insecure-!dcmfqtu=0-x7ciy+q##tp1x#1oguukj2&57m=2)!&&mufu#07'
...
INSTALLED_APPS = [
    ...
    "channels",
    "rest_framework",
    "AssessmentAPI.apps.AssessmentapiConfig",
    "AssessmentArch.apps.AssessmentArchConfig",
]
